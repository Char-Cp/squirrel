        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../../goods/editGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                   ...
                   <div class="changeinfo">
                        <span>数量：</span>
                        <input class="in_info" type="text" name="realPrice" placeholder="请输入商品数量" value="${goodsExtend.goods.realPrice}"/>
                        <span id="checkphone">(*选填,请如实填写)</span>
                     </div>
                     <div class="changeinfo">
                        <span>物品类别：</span>
                        <select class="in_info" name="catelogId">
                            <option value="1">军事类</option>
                            <option value="2">经济类</option>
                            <option value="3">教育类</option>
                            <option value="4">体育类</option>
                            <option value="5">艺术类</option>
                            <option value="6">历史类</option>
                            <option value="7">地理类</option>
                        </select>
                    </div>
